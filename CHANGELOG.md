...
- b86bb29: feat: add `credentials` option to PrestConfig
...
- d299526: feat: UUID primary key columns now optional in \*Input types
...
- ff5599d: feat: regenerate types after DB migration 0114 (close type gaps)
...
- c4f3706: feat: regenerate lobehub-types.ts with user_id-optional fix + string dates
...
- f0c8946: feat: type-level CamelTableTypes for auto-camelCase select types
...
- db4a3a3: Bump to 0.7.1 — 0.7.0 was published then unpublished earlier today, and
  npm does not allow reusing an unpublished version number. No code
  changes in this release; it re-ships the auto-camelCase feature from
  the 0.7.0 attempt under a fresh version tag.
